        ...
        <div id="product-page">
            ...
            <div className="product-page">
                <div className="most-rated-product-container full-width flex align-items justify-content">
                    <a href={`/breezybasket/trademark-search/${productTrademark.name}/none`} style={{marginLeft: "20px"}} className="full-height"><img className="full-height" src={productTrademark.src} alt={productTrademark.name} /></a>
                    <a className="recommended-product flex align-items full-height" href={`/breezybasket/product/${mostRatedProduct.id}`}>
                        <div style={{width: "30%"}}>
                ...
                <div className="product-container full-width full-height flex">
                    ...
                    <div className="details-container">
                        ...
                        <a className="sentence" href={`/breezybasket/trademark-search/${productTrademark.name}/none`}>{`see ${productTrademark.name} products`}</a>
                        ...
                        <a href="/breezybasket" onClick={handleStarsClick} className="see-comments">see comments</a>
                        <div>
            ...
            <div className="about-trademark flex align-items full-width">
                <a href={`/breezybasket/trademark-search/${productTrademark.name}/none`}><img src={productTrademark.src} alt={productTrademark.name} className="full-height" /></a>
